...
print("Patching [%s]: CHART_NAME=[%s], VERSION=[%s], MAIN_CHART_NAME=[%s]\n" % (requirement_file_name, CHART_NAME, VERSION, MAIN_CHART_NAME))

config, ind, bsi = load_yaml_guess_indent(open(requirement_file_name), preserve_quotes=True)
